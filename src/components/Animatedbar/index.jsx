        ...
        <div>
            <div className={style.dimentionNavbarContainer}>
                <button className={style.cancelBtn} onClick={() => setIsOpen(false)}>
                    <CloseRoundedIcon style={cancelButton} />
                </button>
                <div className={style.dimentionNavbar}>
                    <ul>
                        <li style={{ zIndex: "5" }}><a href="#home">Home</a></li>
                        <li style={{ zIndex: "4" }}><a href="#about">about</a></li>
                        <li style={{ zIndex: "3" }}><a href="#services">Services</a></li>
                        <li style={{ zIndex: "2" }}><a href="#portfolio">Sites</a></li>
